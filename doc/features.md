...
| Needs | supply_trader | Supply drive overdue; squad heads to a trader. | RADIANT_CALLBACKS | alignment_human; Hull(supply); personality(greed, relation) | find_smart in radio range; filter has_stalker_jobs(JOB_TYPE_TRADER) | publish cause:supply_trader |
